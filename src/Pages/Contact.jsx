...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Here, you could make an API call or handle form submission.
  };

  return (
    <div className="bg-blue-800 text-white min-h-screen flex items-center justify-center">
...
export default ContactPage;  // Ensure default export
